...
clarification.addEventListener("click", () => platform.openUrl(dict.clarification_url));
...
form.append(el("p", "gate-lede", "Enter your password to turn sync back on for this device."));
const pw = el("input");
pw.type = "password";
...
if (!cryptoAvailable()) {
document.body.replaceChildren(el("p", "empty", "lexis needs a browser with Web Crypto (and a secure https connection)."));
return;
}
